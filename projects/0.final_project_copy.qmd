...
detailed <- read_csv("projects/data/240521_MG/21-32-07/Imaris/21-32-07_100x_CA1_1_Statistics/21-32-07_100x_CA1_c1_Detailed.csv", col_names = TRUE, skip = 3)
...
write.csv(df, "projects/data/Sholl.csv", row.names = FALSE)
```
...
write.csv(data, "projects/data/Sholl.csv", row.names = FALSE)
```
...
meta <- read.csv("projects/data/240521_MG/meta_sholl.csv", header = TRUE, stringsAsFactors = FALSE, colClasses = "character")
head(meta)
```
